@extends('layouts.main') @section('body')
    ...
    <div class="col-md-8">
        <form action="/assessmentAdmin/update" method="post">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <input type="text" class="form-control @error('employee_id') is-invalid @enderror"
                            ...
                            value="{{ old('compmetency_id', $assessment->employee_id) }}" readonly />
                ...
                <div class="col-sm-5">
                    <input type="text" name="employee_name" id="employee_name"
                        ...
                        value="{{ old('employee_name', $assessment->employee_name) }}" placeholder="employee name"
                        readonly />
                </div>
                @error('employee_id')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="position" id="position"
                        ...
                        value="{{ old('position', $assessment->position) }}" placeholder="position" readonly />
                </div>
                @error('position')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select class="custom-select" name="year" id="year">
                        <option @if (old('year', $assessment->year) == '2023') selected @endif>2023</option>
                        <option @if (old('year', $assessment->year) == '2024') selected @endif>2024</option>
                        <option @if (old('year', $assessment->year) == '2025') selected @endif>2025</option>
                        <option @if (old('year', $assessment->year) == '2026') selected @endif>2026</option>
                        <option @if (old('year', $assessment->year) == '2027') selected @endif>2027</option>
                    </select>
                </div>
                @error('year')
                    <div class="invalid-feedback">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <select class="custom-select" name="status" id="status">
                        <option value="1" @if (old('status', $assessment->status) == '1') selected @endif>Self Assessment</option>
                        <option value="2" @if (old('status', $assessment->status) == '2') selected @endif>Review by Superior
                        </option>
                ...
                <div class="col-sm-3">
                    <select class="custom-select" name="status_launch" id="status_launch">
                        ...
                        <option value="2" @if (old('status_launch', $assessment->status_launch) == '2') selected @endif>Not Actived</option>
                    </select>
                </div>
                @error('year')
                    <div class="invalid-feedback">
