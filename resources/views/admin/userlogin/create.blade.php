            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="text" name="job_level" id="job_level"
                        class="form-control @error('job_level') is-invalid @enderror" autofocus
                        value="{{ old('job_level') }}" placeholder="job_level" readonly />
                </div>
                @error('position')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="email" id="email"
                        class="form-control @error('email') is-invalid @enderror" autofocus value="{{ old('email') }}"
