<aside class="aside aside-fixed">
    ...
    <div class="aside-body">
        ...
        <ul class="nav nav-aside">
            ...
            <li class="nav-item {{ request()->is('generalDashboard*') ? 'active' : '' }}">

                <a href="/generalDashboard" class="nav-link">
                    <i data-feather="pie-chart"></i> <span>Dashboard</span>
                </a>
            </li>
            <li class="nav-item mg-t-25 {{ request()->is('generalAldp*') ? 'active' : '' }}">
                <a href="/generalAldp" class="nav-link">
                    <i data-feather="clipboard"></i> <span>ALDP</span>
                </a>
            </li>
            <li class="nav-item mg-t-25 {{ request()->is('generalAssessment*') ? 'active' : '' }}">
                <a href="/generalAssessment" class="nav-link">
                    <i data-feather="check-square"></i> <span>Assessment Verify</span>
                </a>
            </li>

            <li class="nav-item mg-t-25 {{ request()->is('generalSubordinate*') ? 'active' : '' }}">
                <a href="/generalSubordinate" class="nav-link">
