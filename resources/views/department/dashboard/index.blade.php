        ...
        <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
            ...
            <div class="row row-xs">
                ...
                <div class="col-md-6 col-xl-4 mg-t-10">
                    <div class="card ht-lg-100p">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h6 class="mg-b-0">Progress Team</h6>
                        ...
                        <div class="card-body pd-b-0">
                            <div class="row mg-b-20">
                                <div class="col">
                                    <h4 class="tx-normal tx-rubik tx-spacing--1 mg-b-10">$150,200</h4>
                                    <p class="tx-sans tx-11 tx-uppercase tx-spacing-1 tx-medium tx-color-03">Competent</p>
                                </div>
                                <div class="col">
                                    <h4 class="tx-sans tx-normal tx-rubik tx-spacing--1 mg-b-10">$21,880 </h4>
