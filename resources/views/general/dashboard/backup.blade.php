<div class="row row-xs">
                        ...
                        <svg width="331.328" height="200">
                            <g transform="scale(0.3372681281618887) translate(11.693759999999964, 0)">
                                <path
                                    ...
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_hi"
                                ...
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ak"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#69b2f8" original="#69b2f8" id="jqvmap1_fl"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_nh"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_mi"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_vt"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_me"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ri"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#69b2f8" original="#69b2f8" id="jqvmap1_ny"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_pa"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_nj"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_de"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_md"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_va"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_wv"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_oh"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_in"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_il"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ct"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_wi"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_nc"
                                    class="jqvmap-region"></path>
                                <path d="m803.44,248.16c2.67,3.43 3.85,-1.02 0.55,-0.75l-0.29,0.4 -0.25,0.35z"
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_dc"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ma"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_tn"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ar"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_mo"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ga"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_sc"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ky"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_al"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_la"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ms"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ia"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_mn"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ok"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#69b2f8" original="#69b2f8" id="jqvmap1_tx"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_nm"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ks"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ne"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_sd"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_nd"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#69b2f8" original="#69b2f8" id="jqvmap1_wy"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_mt"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_co"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_id"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_ut"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_az"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_nv"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_or"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#d1e6fa" original="#d1e6fa" id="jqvmap1_wa"
                                    class="jqvmap-region"></path>
                                <path
                                    ...
                                    stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-opacity="0.25" fill="#69b2f8" original="#69b2f8" id="jqvmap1_ca"
                                    class="jqvmap-region"></path>
                            </g>
                        </svg>
                    </div>
    ...
    <div class="col-lg-12 col-xl-8 mg-t-10">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="tx-medium text-right">$28,670.90 <span
                                    class="mg-l-5 tx-10 tx-normal tx-success"><i class="icon ion-md-arrow-up"></i>
                                    4.5%</span></td>
                        </tr>
                        <tr>
                            ...
                            <td class="tx-medium text-right">$26,930.40 <span
                                    class="mg-l-5 tx-10 tx-normal tx-danger"><i class="icon ion-md-arrow-down"></i>
                                    0.8%</span></td>
                        </tr>
                        <tr>
                            <td class="tx-color-03 tx-normal">03/04/2018</td>
        ...
        <div class="card card-body ht-lg-100">
            <div class="media">
                <span class="tx-color-04"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" class="feather feather-download wd-60 ht-60">
                ...
                <li class="list-group-item d-flex pd-sm-x-20">
                    ...
                    <div class="mg-l-auto d-flex align-self-center">
                        <nav class="nav nav-icon-only">
                            ...
                            <a href="" class="nav-link d-sm-none"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="row mg-b-20">
                    <div class="col">
                        <h4 class="tx-normal tx-rubik tx-spacing--1 mg-b-10">$150,200 <small
                                class="tx-11 tx-success letter-spacing--2"><i class="icon ion-md-arrow-up"></i>
                                0.20%</small></h4>
                    ...
                    <div class="col">
                        <h4 class="tx-normal tx-rubik tx-spacing--1 mg-b-10">$21,880 <small
                                class="tx-11 tx-danger letter-spacing--2"><i class="icon ion-md-arrow-down"></i>
                                1.04%</small></h4>
