            ...
            <div class="row row-xs">
                    ...
                    <div class="card card-body">
                        ...
                        <div class="chart-three">
                            <div id="flotChart4" class="flot-chart ht-30" style="padding: 0px; position: relative;"><canvas
                                    class="flot-base" width="250" height="30"
                                    style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 250.5px; height: 30px;"></canvas><canvas
                                    class="flot-overlay" width="250" height="30"
                        ...
                        <div class="card-body pd-20">
                            <div class="chart-two mg-b-20">
                                <div id="flotChart2" class="flot-chart" style="padding: 0px; position: relative;"><canvas
                                        class="flot-base" width="455" height="210"
                                        style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 455.156px; height: 210px;"></canvas>
                                    <div class="flot-text"
                                        style="position: absolute; inset: 0px; font-size: smaller; color: rgb(84, 84, 84);">
                                        <div class="flot-x-axis flot-x1-axis xAxis x1Axis"
                                            style="position: absolute; inset: 0px;">
                                            <div class="flot-tick-label tickLabel"
                                                style="position: absolute; max-width: 75px; top: 197px; left: 2px; text-align: center;">
                                                Jan</div>
                                            <div class="flot-tick-label tickLabel"
                                                style="position: absolute; max-width: 75px; top: 197px; left: 88px; text-align: center;">
                                                Feb</div>
                                            <div class="flot-tick-label tickLabel"
                                                style="position: absolute; max-width: 75px; top: 197px; left: 172px; text-align: center;">
                                                Mar</div>
                                            <div class="flot-tick-label tickLabel"
                                                style="position: absolute; max-width: 75px; top: 197px; left: 259px; text-align: center;">
                                                Apr</div>
                                            <div class="flot-tick-label tickLabel"
                                                style="position: absolute; max-width: 75px; top: 197px; left: 343px; text-align: center;">
                                                May</div>
                                            <div class="flot-tick-label tickLabel"
                                                style="position: absolute; max-width: 75px; top: 197px; left: 408px; text-align: center;">
                                                Jun</div>
                                        </div>
                                    </div><canvas class="flot-overlay" width="455" height="210"
                                        style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 455.156px; height: 210px;"></canvas>
                                </div>
                            </div><!-- chart-two -->
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <div class="tx-12 tx-color-03">Customers who have upgraded the level of your products
                                        or service.</div>
                                </div><!-- col -->
                                <div class="col-sm mg-t-20 mg-sm-t-0">
                                    ...
                                    <div class="tx-12 tx-color-03">Customers who have ended their subscription with you.
                                    </div>
                                </div><!-- col -->
                            </div><!-- row -->
                        </div><!-- card-body -->
                                    ...
                                    <svg width="331.328" height="200">
                                        <g transform="scale(0.3372681281618887) translate(11.693759999999964, 0)">
                                            <path
                                                ...
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_hi" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ak" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#69b2f8"
                                                original="#69b2f8" id="jqvmap1_fl" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_nh" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_mi" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_vt" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_me" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ri" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#69b2f8"
                                                original="#69b2f8" id="jqvmap1_ny" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_pa" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_nj" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_de" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_md" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_va" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_wv" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_oh" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_in" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_il" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ct" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_wi" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_nc" class="jqvmap-region"></path>
                                            <path d="m803.44,248.16c2.67,3.43 3.85,-1.02 0.55,-0.75l-0.29,0.4 -0.25,0.35z"
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_dc" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ma" class="jqvmap-region"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ar" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_mo" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ga" class="jqvmap-region"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ky" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_al" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_la" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ms" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ia" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_mn" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ok" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#69b2f8"
                                                original="#69b2f8" id="jqvmap1_tx" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_nm" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ks" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ne" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_sd" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_nd" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#69b2f8"
                                                original="#69b2f8" id="jqvmap1_wy" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_mt" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_co" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_id" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_ut" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_az" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_nv" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_or" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#d1e6fa"
                                                original="#d1e6fa" id="jqvmap1_wa" class="jqvmap-region"></path>
                                            <path
                                                ...
                                                stroke="#fff" stroke-width="1" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-opacity="0.25" fill="#69b2f8"
                                                original="#69b2f8" id="jqvmap1_ca" class="jqvmap-region"></path>
                                        </g>
                                    </svg>
                                </div>
                            </div>
                ...
                <div class="col-lg-12 col-xl-8 mg-t-10">
                    ...
                    <div class="card card-body ht-lg-100">
                        <div class="media">
                            <span class="tx-color-04"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    class="feather feather-download wd-60 ht-60">
                            ...
                            <li class="list-group-item d-flex pd-sm-x-20">
                                ...
                                <div class="mg-l-auto d-flex align-self-center">
                                    <nav class="nav nav-icon-only">
                                        <a href="" class="nav-link d-none d-sm-block"><svg
                                        ...
                                        <a href="" class="nav-link d-sm-none"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="card-body pd-b-0">
                            <div class="row mg-b-20">
                                ...
                                <div class="col">
                                    ...
                                    <p class="tx-11 tx-uppercase tx-spacing-1 tx-medium tx-color-03">Avg. Sales Per Day
                                    </p>
                                </div>
                            </div><!-- row -->
                            <div class="chart-five">
                                <div>
                                    ...
                                    </div><canvas id="chartBar1" width="341" height="225"
                                        style="display: block; width: 341px; height: 225px;"
                        ...
                        <div class="card-body pos-relative pd-0">
                            ...
                            <div class="chart-one">
                                <div id="flotChart" class="flot-chart" style="padding: 0px; position: relative;">
                                    <canvas class="flot-base" width="640" height="350"
                                        style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 640.828px; height: 350px;"></canvas>
                                    <div class="flot-text"
                                        style="position: absolute; inset: 0px; font-size: smaller; color: rgb(84, 84, 84);">
                                        <div class="flot-x-axis flot-x1-axis xAxis x1Axis"
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer pd-20">
                            <div class="row">
                                ...
                                <div class="col-6 mg-t-10">
                                    <p class="tx-10 tx-uppercase tx-medium tx-color-03 tx-spacing-1 mg-b-5">Need
                                        Improvement
                                    </p>
                                    <div class="d-flex align-items-center">
