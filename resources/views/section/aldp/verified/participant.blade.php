@extends('layouts.main') @section('body')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        ...
        <div class="d-none d-md-block">
            <a href="/sectionAldpShowFinish/{{ $id_aldp }}" class="btn btn-sm pd-x-15 btn-danger btn-uppercase mg-l-5">
        ...
        <table id="viewdata" class="table table-bordered tx-12 table-hover">
            ...
            <tbody>
                ...
                @foreach ($data as $view)
                    ...
                    <tr>
                        <td>
                            <form action="/sectionAldpDeleteParticipant" method="post" class="d-inline"
