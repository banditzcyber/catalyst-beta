...
Route::prefix('closegapfunctional')->group(function () {
    ...
    Route::get('/update/{id}', [CloseGapFunctionalController::class, 'updateData']);
});
Route::prefix('closegapleadership')->group(function () {
    ...
    Route::get('/update/{id}', [CloseGapLeaderShipController::class, 'updateData']);
});
Route::prefix('closegapother')->group(function () {
    ...
    Route::get('/update/{id}', [CloseGapOtherController::class, 'updateData']);
});
